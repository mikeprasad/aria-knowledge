...
- **Marker token = `aria:simplification`** — verified collision-free across proj-a/proj-b/df on 2026-06-23. Do NOT change the token without re-running the collision grep.
