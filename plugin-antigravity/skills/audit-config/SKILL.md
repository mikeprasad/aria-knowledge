...
2. Glob CLAUDE.md files in the project + ancestor directories + `~/.gemini/antigravity/transcripts/.../memory/project_*.md` files referencing the project's slug.
...
Surfaces to scan are the same as 3a.1: CLAUDE.md files in the working tree, README.md files, and project memory files in `~/.gemini/antigravity/transcripts/.../memory/`.
