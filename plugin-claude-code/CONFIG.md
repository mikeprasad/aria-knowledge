...
| `planning_paths` | comma-separated patterns | empty | pre-edit-check.sh, post-edit-check.sh |
| `preflight_gate` | `off` \| `warn` \| `deny` | warn | pre-commit-preflight-check.sh |
| `preflight_deny_paths` | space-separated globs | empty | pre-commit-preflight-check.sh |
| `preflight_deny_repos` | comma-separated path substrings | empty | pre-commit-preflight-check.sh |
