...
# B5: /handoff resume scaffold ("cs\n  Resume proj-a...") dropped even with a leading label line
echo "$N" | grep -qi "Resume proj-a" && bad "B resume-scaffold" "resume scaffold leaked" || ok "B drops resume scaffold"
