...
> **Historical baseline (2026-05-18, canonical v2.16.1).** Current port status: **`2.30.0-cursor.0`** (2026-06-11 — tracks canonical v2.30.0). See `../PORTING.md` for live sync notes and `../../CHANGELOG.md`. Re-run `./release-cursor.sh` after changes.
