...
> **Historical baseline (2026-05-18, canonical v2.16.1).** Current port status: **`2.24.2-cursor.0`** (2026-06-04 — tracks canonical v2.24.2; statusline-only delta, not ported). See `../PORTING.md` for live sync notes and `../../CHANGELOG.md`. Re-run `./release-cursor.sh` after changes.
