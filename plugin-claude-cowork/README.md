...
- 24 colliding skill names now deterministically route to **aria-knowledge** when both plugins are loaded (per ADR-094 (`{knowledge_folder}/projects/aria/decisions/094-bare-slash-canonical-owner-and-dual-runtime-gate.md`)).
