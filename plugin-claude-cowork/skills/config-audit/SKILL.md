---
name: config-audit
description: 'Alias for /audit-config. Invoked by "/aria-cowork:config-audit". Same behavior as /aria-cowork:audit-config — just an alternative phrasing. (Cowork alias — namespaced-only.)'
argument-hint: ''
---
